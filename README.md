...
Automatizar la recolección de posts recientes desde X usando keywords y operadores avanzados.
Aplicar limpieza y normalización de texto para mejorar calidad de datos.
Generar archivos CSV estructurados y reproducibles.
